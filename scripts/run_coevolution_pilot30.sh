...
#
# Usage:
#   scripts/run_coevolution_pilot30.sh /path/to/Dr-CiK_public/tasks
#
...
export EA_VAL_FRACTION="${EA_VAL_FRACTION:-0.20}"
...
export EA_SCREEN_VAL_TASKS="${EA_SCREEN_VAL_TASKS:-2}"
