...
class OutcomeSkillLearner:
    ...
    def learn(
        ...
        decision_eligible = (
            ...
            and outcome.decision_selection_smae_regret <= self.config.maximum_decision_regret
            and outcome.decision_selection_srmse_regret <= self.config.maximum_decision_regret
        )
