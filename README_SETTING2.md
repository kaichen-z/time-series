...
This branch ports the Setting 2 external-knowledge component onto the current upstream architecture
...
| `docs/SETTING2_DOMAIN_KNOWLEDGE.md` | Knowledge design and research basis |
| `docs/EVOLUTION_UPGRADE_AND_COEVOLVE_REPORT_20260816.md` | Historical inner/outer evolution report |
| `docs/FULL_DRCIK_EVOLUTION_AND_FROZEN30_REPORT_20260816.md` | Historical curriculum and final statistics |
